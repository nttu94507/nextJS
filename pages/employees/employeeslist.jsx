            ...
            return data.d.map(dat => (
                ...
                <div className={`${styles.card} = ${styles.display}`} key={dat.id}>
                    ...
                    <div className={`${styles.cardbuttom} ${styles.display}`}>
                        <Link href={`/employees/edit/${dat.id}`}><div className={`${styles.flex1} ${styles.justfy} ${styles.display} ${styles.btnleft}`}>修改</div></Link>
                        <Link href={`/employees/infomation/${dat.id}`}><div className={`${styles.flex1} ${styles.justfy} ${styles.display} ${styles.btnright}`} 
                        >詳細</div></Link>
                    </div>
                </div>
            )
...
Employeeslist.getLayout = getLayout;
